...
<div class="grid gA" style="align-items:center">
 ...
 <div>
  ...
  <ul class="tk" style="margin-top:1.4rem">
   ...
   <li><b>وما عدا ذلك: لا شيء — في الحالة الأساسية.</b> لا جلوسَ ولا بارَ ولا مظلّةَ ولا نافذةَ عرض. الكتلةُ نظيفة —
  ...
  <div class="note" style="margin-top:1.4rem">
   <b>مقترحٌ مطروح — جلسةٌ خارجية على الضِّلعين الخلفيّ والأيسر.</b>
   بارٌ من مادّة الكتلة نفسها يلتفّ حول الوجهين البعيدين عن الخدمة، ومقاعدُ منه، وضبابٌ باردٌ يسقط عليها.
   يلتفُّ خلفاً ويساراً لا أماماً، فلا يعترض الطابورَ ولا يحجب الفتحات. وهو <b>خارج أرقام هذا العرض</b> —
   كلُّ رقمٍ في الصفحات التالية قائمٌ بدونه — ومطروحٌ لتقرّره اللجنة، بحسابه كاملاً:
   <b>ما يكلّف:</b> ثمانيةَ عشرَ متراً طوليّاً بـ٣٢٧ دولاراً للمتر = <b>٥,٨٨٦ دولاراً</b> رأسَ مال (وهو الرقمُ
   نفسه الذي كان في الجدول قبل حذفه)، وحصّةُ رصيفٍ إضافيةٌ في الإيجار، ونظافةٌ ومناوبةٌ أطول،
   و<b>إعادةُ صبٍّ دوريّة</b> — بارُ الثلج يذوب، فهو بندٌ استهلاكيٌّ لا أصلٌ ثابت.
   <b>وما يُعيد:</b> حين أُلغي الجلوسُ نهائياً خُفِّض أساسُ العمليات في النموذج من ٣٠٠ إلى ٢٧٠ عمليةً يومياً،
   لأنّ صيغةَ الأخذ‑والمضيّ تكسب سرعةً وتخسر مناسبةَ البقاء. وإعادةُ الجلوس تُعيد الحجّةَ لذلك العشرة بالمئة:
   نحو <b>٧٢ ألف دولارٍ</b> إيراداً إجماليّاً إضافيّاً في السنة الثانية — بشرط أن يستوعبها الإنتاجُ دون طابورٍ أطول.
   <b>وما يُخاطر به:</b> المكعّبُ اليوم يُقرأ كتلةً واحدةً نظيفة، والبارُ يُدخِل أثاثاً إلى صورةٍ قوّتُها في خلوّها منه.
  </div>
  <div class="note" style="margin-top:1.4rem">
