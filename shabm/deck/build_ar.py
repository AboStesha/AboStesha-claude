...
<div class="grid gA" style="align-items:center">
 ...
 <div>
  ...
  <ul class="tk" style="margin-top:1.4rem">
   ...
   <li><b>مجسّماتٌ مجمّدةٌ في الجدار.</b> فاكهةٌ حقيقيّة وحبوبُ بُنٍّ وأدواتٌ مغمورةٌ في اللوح أثناء صبّه،
   تُرى بوضوحٍ على أعماقٍ مختلفة كأنّها تجمّدت داخل الكتلة. مصبوبةٌ لا مطبوعة — لا تُقشَّر ولا تبلى.</li>
   <li><b>زاويةٌ واحدة شفّافة.</b> استثناءٌ مقصودٌ في كتلةٍ مصمتة: لوحٌ أكريليك صافٍ بصريّاً، وخلفه
   <b>صحنُ اللفائف</b> وحدَه مُضاءً. يرى الناسُ الكشطَ على الصحن البارد، ولا يرون شيئاً آخر من المطبخ.
   المشهدُ الذي يُصوَّر معروضٌ، والفوضى مخفيّة.</li>
   <li><b>مظلّةٌ فوق الجلوس.</b> قماشٌ مشدودٌ كابوليّاً من جسم الكتلة على الجهات الثلاث، بلا عمودٍ واحدٍ
   في الرصيف. بلا ظلٍّ لا يجلس أحدٌ في تموز: الشمسُ المباشرة عند ٤٥ درجة تُلغي أثرَ الرذاذ كلَّه.</li>
   <li><b>بارٌ ملتصقٌ بالكتلة.</b> ينبت من الجناح الأيمن والأيسر ويلتفّ حول الظهر كاملاً — طاولةٌ ومقاعدُ من
   المادّة نفسها، مثبَّتةٌ في الجسم لا واقفةٌ بجانبه. و<b>واجهةُ الخدمة تبقى خالية</b>: لا بارَ ولا مقعدَ
   أمام الفتحات الثلاث.</li>
  </ul>
...
<div class="note hard" style="margin-top:1.6rem">
 <b>أُعيد بناءُ هذا الرقم من الصفر، ثم صُغِّر البووث نفسه. النتيجة ٣٥٪ أقلّ.</b>
 النسخةُ الأولى قالت <span class="n">$538,944</span> لكشكٍ مساحتُه ٢٥ متراً — نحو
 <span class="n">$21,500</span> للمتر المربّع، وهو رقمٌ لا يُصدَّق. خمسةُ تصحيحات:
 <b>أوّلاً</b> عُدّةُ الامتياز بـ<span class="n">$45,000</span> كانت مُحمَّلةً على الفرع، وهي كلفةُ الشركة
 المانحة تُكتَب مرّةً وتستعملها كلُّ الفروع؛ نُقِلت إلى مكانها.
 <b>ثانياً</b> مصنعُ ثلجٍ بثلاث وحداتٍ بـ<span class="n">$34,000</span> حيث تكفي وحدة.
 <b>ثالثاً</b> تقديرٌ إجماليٌّ للغلاف بدل حسابِ مساحة.
 <b>رابعاً</b> <span class="n">$18,300</span> على تشطيبٍ داخل كتلةٍ لا يراها زبونٌ أبداً.
 <b>وخامساً</b> — وهو الأكبر أثراً — <b>المساحة نفسها</b>: نزلت من ٢٥ متراً إلى
 <b>١٨</b>، والغلافُ من ٩٨ متراً مربّعاً إلى <b>٧٥</b>. لا جلوسَ في الداخل ولا صالةَ انتظار ولا كاشير،
 فالمطلوبُ خطُّ إنتاجٍ وممرٌّ خلفه. والمترُ الزائد يُدفَع ثمنُه مرّتين: مرّةً في البناء ومرّةً كلَّ شهرٍ
 في تبريده.
 <br><br>
 وأُضيف بندان جديدان بكامل كلفتهما، لا خصماً منهما: <b>زاويةُ العرض</b> الشفّافة على صحن اللفائف
 بـ<span class="n">$4,200</span>، و<b>المظلّة</b> فوق الجلوس بـ<span class="n">$6,500</span> —
 والثانيةُ ليست ترفاً: بلا ظلٍّ لا يجلس أحدٌ في تموز، والمقاعدُ الثمانيةَ عشرَ تصير زينة.
 <br><br>
 الرقمُ اليوم <b class="n">{usd(FLAG["capex"]["total"])}</b>، والاستردادُ نزل من ٤٢.٥ شهراً إلى
 <b class="n">{FLAG["payback_months"]:.1f}</b>، والعائدُ الداخلي صعد إلى
 <b class="n">{FLAG["irr_5y"]:.0f}%</b>.
</div>
