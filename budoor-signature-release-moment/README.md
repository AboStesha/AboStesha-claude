...
- Single-show storyboard deck v3, Arabic (magician lines on every scene) (21 pages, wall content matched to the project renders in img/aerial.jpg, villa.jpg, entrance.jpg, one 3:45 show combining the three ideas, magician script AR/EN, cue sheet; built from `index_show_ar.html` via `assemble_show.py`, images `img/show_0..17.jpg`): https://d2ol7oe51mr4n9.cloudfront.net/user_31whQkWWK9m41YEVOr0IugdLlfs/2f17fa28-a303-48c2-9c44-a3a4edd09b5f.pdf
