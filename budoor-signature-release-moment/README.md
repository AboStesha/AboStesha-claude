...
- Single-show storyboard deck, Arabic (21 pages, one 3:45 show combining the three ideas, magician script AR/EN, cue sheet; built from `index_show_ar.html` via `assemble_show.py`, images `img/show_0..17.jpg`): https://d2ol7oe51mr4n9.cloudfront.net/user_31whQkWWK9m41YEVOr0IugdLlfs/ceeba4bd-7c16-4a99-962b-97754d85764a.pdf
